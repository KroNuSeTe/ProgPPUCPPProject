...
Input from cin.get(); output to cout
...
Statement:
  ...
  Declaration: # x=val1; or # const x=val1; now can create variables and constant variables
	A Struct of a Variable:
	  bool constant;
	  string name;
	  double value;
    Create a class Symbol_table with the functions:
